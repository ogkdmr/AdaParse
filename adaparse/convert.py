...
# FOXTROT: adaparse import fix
import sys, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]  # directory containing 'adaparse/'
...
def parse_pdfs(
    ...
    # Loads parser into memory and registers them in a global registry unique
    # to the current parsl worker process: ensures that the models are only
